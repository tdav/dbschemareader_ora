...
namespace CoreTest
{
    ...
    public class OracleDataExporterTest
    {
        ...
        public void TestSelectLastRecordsSqlWithoutPrimaryKey()
        {
            ...
            // Assert - should use first column when no PK
        ...
        public void TestEscapeNamesDisabled()
        {
            ...
            // Assert
            Assert.IsTrue(sql.Contains("ORDER BY ORDER_ID DESC"), "Should not escape column names: " + sql);
            Assert.IsFalse(sql.Contains("\"ORDER_ID\""), "Should not have quoted column names: " + sql);
        }
